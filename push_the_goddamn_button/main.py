...
def update_count(): return P(count.value, id='count')
    
def update_counter_txt(pg13): return P(f"Number of{' goddamn' if pg13 else ''} button pushes: ", hx_swap_oob='true', id='counter_txt')
